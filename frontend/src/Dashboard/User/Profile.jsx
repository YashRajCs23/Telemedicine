...
export default function Profile() {
    ...
    const fetchUserProfile = async () => {
        try {
            // NOTE: You need to save the user's ID in localStorage on login
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await fetchUserProfile(); // Refetch data to show updates
                        ...
                        <div className="text-center mb-6">
                            <div className="relative inline-block">
                                <div className="w-32 h-32 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto">
                                    <span className="text-white text-4xl font-semibold">{getInitials(user.name)}</span>
                                </div>
                                <button className="absolute bottom-0 right-0 w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center hover:bg-blue-700">
                                    <Camera size={16} />
                                </button>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                             ...
                             {/* Other fields like DOB, Age, etc. are not in the model. Kept as placeholders for now. */}
                            <div>
                    ...
                    {isEditing && (
                        <div className="bg-white p-6 rounded-xl shadow-sm border">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <button onClick={handleEditToggle} className="flex items-center gap-2 px-4 py-2 border text-gray-600 rounded-lg hover:bg-gray-50">
                                   <X size={16}/> Cancel
                                </button>
                            </div>
                        </div>
