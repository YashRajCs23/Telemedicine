...
import { Calendar, Stethoscope, Bell, User, Settings, Menu, X, Home } from "lucide-react";
        ...
        <nav className="flex-1 p-4 space-y-2">
          {menu.map((item, i) => (
            <button
              ...
              `}
            >
              <span className={activePage === item.page ? 'text-blue-600' : 'text-gray-400'}>
                {item.icon}
              </span>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center space-x-3 px-4 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-900 truncate">Yash Srivastava</p>
